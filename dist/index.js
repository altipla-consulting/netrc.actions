...
async function run() {
    let auth = [
        `machine ${(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('machine')}`,
        `\tlogin ${(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('user')}`,
        `\tpassword ${(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('password')}`,
        '',
    ];
    await fs__WEBPACK_IMPORTED_MODULE_2__.promises.writeFile((0,path__WEBPACK_IMPORTED_MODULE_3__.resolve)((0,os__WEBPACK_IMPORTED_MODULE_1__.homedir)(), '.netrc'), auth.join('\n'), { flag: 'a', mode: 0o600 });
}
async function main() {
    try {
        await run();
